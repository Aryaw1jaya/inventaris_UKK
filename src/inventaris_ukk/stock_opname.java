...
public class stock_opname extends javax.swing.JFrame {
Connection conn = null;
    ...
    try {
        ...
        Logger.getLogger(stock_opname.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
    private void reset(){
        jTextField1.setText("");
...
private void Tampilkan_Data(){
        String perintah = "SELECT * FROM detail_inv";
        
        try {
            pst = conn.prepareStatement(perintah);
            rs =pst.executeQuery();
            DefaultTableModel tpelang = new DefaultTableModel();
            tpelang.addColumn("id_detail");
            tpelang.addColumn("id_barang");
            tpelang.addColumn("merk");
            tpelang.addColumn("ketersediaan");
            tpelang.addColumn("keterangan");
	    tpelang.addColumn("tgl_masuk");
	 while (rs.next()) {                
                tpelang.addRow(
                        new Object[]{
                            rs.getString(1),
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String update = "UPDATE detail_inv SET keterangan = ? WHERE id_barang = ? AND id_detail = ?";
        
        try {
            pst = conn.prepareStatement(update);
           pst.setString(1,jTextField5.getText());
           pst.setString(3,jTextField1.getText());
           pst.setString(2,klik);
            pst.execute();
             Tampilkan_Data();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int row = jTable1.getSelectedRow();
        String klik = jTable1.getModel().getValueAt(row, 0).toString();
        String select = "SELECT * FROM detail_inv WHERE  id_detail = '"+klik+"'";
        ...
        try {
            ...
            if (rs.next()){
                String tulisan1 = rs.getString("id_detail");
                jTextField1.setText(tulisan1);

                String tulisan2 = rs.getString("id_barang");
                jTextField2.setText(tulisan2);

                String tulisan3 = rs.getString("merk");
                jTextField3.setText(tulisan3);

                String tulisan4 = rs.getString("ketersediaan");
                jTextField4.setText(tulisan4);
                
                String tulisan5 = rs.getString("keterangan");
                jTextField5.setText(tulisan5);
                
                String tulisan6 = rs.getString("tgl_masuk");
                jTextField6.setText(tulisan6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stock_opname.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
